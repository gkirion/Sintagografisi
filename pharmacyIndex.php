...
#footer {
    ...
    <body>
        <?php
            ...
            $sql = "select * from pharmacy where id='$usr' and password='$pwd'";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                <div id="nav">
                <table>
                <tr><th colspan="2" align="left">Στοιχεία φαρμακείου</th></tr>
                <?php
                ...
                ?>
                <tr><td><form action="http://snf-655727.vm.okeanos.grnet.gr/PhpProject1/pharmacyLogin.htm"><button type="submit">Έξοδος</button></form></td></tr>
                </table>
                </div>
                <div id="non-floater">
                <div id="section">
                    <iframe width="100%" height="1000px" src="pharmacySintagiSearchPage.htm" name="main_iframe"></iframe>
                </div>
                </div>
                <div id="footer">
                </div>
