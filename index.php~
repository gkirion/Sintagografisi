...
#footer {
    ...
    <body>
        <?php
            ...
            $sql = "select * from doctor where tsay='$usr' and password='$pwd'";
            ...
            if (mysqli_num_rows($result) > 0) {
               ...
               <!-- <h1>Hello</h1> -->
                ...
                ?>
                <tr><td><form action="http://snf-655727.vm.okeanos.grnet.gr/PhpProject1/doctorLogin.htm"><button type="submit">Έξοδος</button></form></td></tr>
                </table>
                </div>
                <div id="non-floater">
                <div id="section">
                <iframe width="100%" height="1000px" src="doctorVisitOpenPage.htm" name="main_iframe"></iframe>
                </div>
                </div>
                <div id="footer">
                </div>
