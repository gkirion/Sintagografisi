...
<thead>
<tr><th class="header">Id</th><th class="header">Όνομα</th><th class="header">Τιμή ανά τεμάχιο</th><th class="header">Ποσότητα</th><th class="header">Συνολική τιμή</th><th class="header">Συμμετοχή ταμείου</th><th class="header">Τελική τιμή</th></tr>
</thead>
<tbody class="list">
<?php
...
<tr><td colspan="3">
        ...
        <form align="right" action="http://snf-655727.vm.okeanos.grnet.gr/PhpProject1/exetasiCompletePage.php" method="post">
        ...
        </form></td><td><form align="right" action="http://snf-655727.vm.okeanos.grnet.gr/PhpProject1/exetasiSearchPage.htm"><button type="submit">Ακύρωση</button></form>
        </td></tr></table>
        ...
        ?>
        <h3>Δεν βρέθηκε παραπεμπτικό με αυτό το αναγνωριστικό</h3>
